...
#         12,
#         selectizeInput(
#           'gene', label = "Gene Name", choices = cflo.annots.exp %>% filter(gene_name %in% bg.genes) %>% pull(gene_name),
#           options = list(create = TRUE))
#       )
#     ),
#     
